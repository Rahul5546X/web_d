        ...
        try {
            ...
            xhr.onreadystatechange = function () {
                ...
                if (xhr.readyState === 4) { //It means the operation is complete.
                    ...
                    const response = apploadData === null || apploadData === void 0 ? void 0 : apploadData.response;
...
function fetchApploadData() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const apploadData = yield response.json();
        const { frequencies, service_category: serviceCategory, extras } = destructObj((_a = apploadData === null || apploadData === void 0 ? void 0 : apploadData.response) === null || _a === void 0 ? void 0 : _a.data);
...
function createFrequencyBtn(frequencies) {
    if (isArrayNotEmpty(frequencies)) {
        ...
        function addActiveTOFirst() {
            const firstBtn = btnContainer === null || btnContainer === void 0 ? void 0 : btnContainer.querySelector(".frequency_btn");
            firstBtn === null || firstBtn === void 0 ? void 0 : firstBtn.classList.add("active");
        }
        function appendBtns(btn, btnName) {
            btn.classList.add("frequency_btn");
            btn.innerText = btnName;
            btnContainer === null || btnContainer === void 0 ? void 0 : btnContainer.appendChild(btn);
        }
        function handleBtnActive(btn) {
            const activeBtn = btnContainer === null || btnContainer === void 0 ? void 0 : btnContainer.querySelector(".active");
            activeBtn === null || activeBtn === void 0 ? void 0 : activeBtn.classList.remove("active");
            btn.classList.add("active");
        }
        for (const frequency of frequencies) {
            try {
                const btnName = frequency === null || frequency === void 0 ? void 0 : frequency.name;
...
//         const selectedOption = servicesList === null || servicesList === void 0 ? void 0 : servicesList.querySelector("select");
//         function createOptionELement(serviceElement) {
//             const serviceName = serviceElement === null || serviceElement === void 0 ? void 0 : serviceElement.name;
//             const serviceId = serviceElement === null || serviceElement === void 0 ? void 0 : serviceElement.id;
//             const optionElement = document.createElement("option");
//             selectedOption === null || selectedOption === void 0 ? void 0 : selectedOption.append(optionElement);
...
//             }
//         }
//         selectedOption === null || selectedOption === void 0 ? void 0 : selectedOption.addEventListener("change", (event) => {
//             let selectedOptionId = event.target.value;
...
function servicesSelector(serviceCategories) {
...
function populateSelectOptions(selectElement, serviceCategories) {
...
function createOptionElement(serviceCategory) {
    const optionElement = document.createElement("option");
    ...
    */
    ...
    if (isArrayNotEmpty(extras)) {
        ...
        for (const extra of extras) {
            try {
                const extrasId = extra === null || extra === void 0 ? void 0 : extra.id;
                const extrasName = extra === null || extra === void 0 ? void 0 : extra.name;
...
function formValidator(event) {
    ...
    const userMail = (_b = document.getElementById("userMail")) === null || _b === void 0 ? void 0 : _b.value.trim();
    const userReview = (_c = document.getElementById("userReview")) === null || _c === void 0 ? void 0 : _c.value.trim();
...
(_a = document.getElementById("myForm")) === null || _a === void 0 ? void 0 : _a.addEventListener("submit", formValidator);
/**
 * getDateTime
...
function btnColorHandler() {
     ...
     */
    function setStyles(button, color) {
    ...
    btnArray.forEach((color) => {
        ...
        button.addEventListener("click", (e) => {
            ...
            e.stopPropagation();
            // Non-Null assertion operator
            const color = (_a = e.target) === null || _a === void 0 ? void 0 : _a.getAttribute("data-color");
            const previouslyActive = btnWrapper.querySelector(".active");
            if (previouslyActive) {
    ...
    selectedBtnInfo.innerText = "No Button is selected.";
    btnTextWrapper === null || btnTextWrapper === void 0 ? void 0 : btnTextWrapper.appendChild(selectedBtnInfo);
}
btnColorHandler();
/**
...
function handleAccordionVisibility() {
    ...
    const accordionToggleBtns = accordionWrapper === null || accordionWrapper === void 0 ? void 0 : accordionWrapper.querySelectorAll(".accordion_heading button");
...
function tooltipPosition() {
    ...
    const textIconWrapper = tooltipWrapper === null || tooltipWrapper === void 0 ? void 0 : tooltipWrapper.querySelector(".js_text_icon_wrapper");
    const tooltipText = tooltipWrapper === null || tooltipWrapper === void 0 ? void 0 : tooltipWrapper.querySelector(".tooltip_text");
    // Non-null assertion operator
    const tooltipTitleValue = tooltipText === null || tooltipText === void 0 ? void 0 : tooltipText.getAttribute("title");
    /**
    ...
    textIconWrapper.addEventListener("mouseenter", () => {
        ...
        tooltipText === null || tooltipText === void 0 ? void 0 : tooltipText.removeAttribute("title");
        tooltipDiv.style.display = "block";
        updateTooltipPosition();
    });
    tooltipWrapper === null || tooltipWrapper === void 0 ? void 0 : tooltipWrapper.addEventListener("mouseleave", () => {
        tooltipText === null || tooltipText === void 0 ? void 0 : tooltipText.setAttribute("title", tooltipTitleValue);
...
function threeLevelDropDown() {
    ...
    function closeNestedDropDowns(element) {
        ...
        nestedDropDowns.forEach((dropDown) => {
            ...
            (_b = (_a = dropDown.parentElement) === null || _a === void 0 ? void 0 : _a.querySelector(".dropdown_icon")) === null || _b === void 0 ? void 0 : _b.classList.remove("rotate");
        });
    }
}
threeLevelDropDown();
    ...
    function closeSidebar() {
        ...
        if (sidebar.classList.contains("sidebar_active")) {
            for (const btn of sidebarButtons) {
                // Non-null assertion operator
                const button = btn;
                const className = button.dataset.side;
...
function addOverlay() {
    const mainContent = document.querySelector(".main_content");
    mainContent === null || mainContent === void 0 ? void 0 : mainContent.classList.add("overlay");
}
function removeOverlay() {
    const mainContent = document.querySelector(".main_content");
    mainContent === null || mainContent === void 0 ? void 0 : mainContent.classList.remove("overlay");
}
/**
 * toggleSidebar
...
function toggleSidebar() {
    ...
    for (const btn of sidebarControlBtns) {
        ...
        btn.addEventListener("click", (e) => {
            e.stopPropagation();
            sidebar === null || sidebar === void 0 ? void 0 : sidebar.classList.remove("sidebar_right_in", "sidebar_left_out", "sidebar_top", "sidebar_bottom", "sidebar_left_in");
            const className = button.dataset.side;
            sidebar === null || sidebar === void 0 ? void 0 : sidebar.classList.add(className);
            sidebar === null || sidebar === void 0 ? void 0 : sidebar.classList.add("sidebar_active");
            addOverlay();
        });
    }
}
...
function handleTwoPopUps() {
    ...
    function openPopUps() {
         ...
         * opens the popup by removing popup_invisible class from it and adding popup_visible class to it.
         */
        function openPopUpEditTemplate(e) {
            e.stopPropagation();
    ...
    function closePopUps() {
        ...
        */
        ...
        closeEditTemplateBtns === null || closeEditTemplateBtns === void 0 ? void 0 : closeEditTemplateBtns.forEach((btn) => {
            btn.addEventListener("click", () => {
                closePopUp(editTemplatePopUp);
                removeOverlay();
            });
        });
        closeShortCodeBtn === null || closeShortCodeBtn === void 0 ? void 0 : closeShortCodeBtn.addEventListener("click", () => {
...
function positionDropDownForm() {
    ...
    function updateFormPosition() {
        // Non-null assertion operator
        const position = dropDownBtn === null || dropDownBtn === void 0 ? void 0 : dropDownBtn.getBoundingClientRect();
        const formHeight = dropDownForm.offsetHeight;
        const formWidth = dropDownForm.offsetWidth;
        if (position.top < formHeight) { //below
            dropDownForm.style.top = `${dropDownBtn === null || dropDownBtn === void 0 ? void 0 : dropDownBtn.offsetHeight}px`;
        }
        else { //above
...
function combineObjects() {
    ...
    let combinedObject = Object.assign(Object.assign(Object.assign({}, firstObject), secondObject), thirdObject);
