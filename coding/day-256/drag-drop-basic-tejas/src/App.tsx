...
function App() {
   ...
   function dragEndHandler(result:ResultPrevState) { //TODO Change the type
   ...
   return (
      <DragDropContextProvider onDragEnd={dragEndHandler} onchange={getFinalData}>
         <Container>
            ...
            <Droppable
                  ...
                  className='mb-5 p-4 bg-danger d-flex gap-3 justify-content-between'
               >
